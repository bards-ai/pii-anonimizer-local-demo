---
title: "Model Card"
description: "Architecture, performance metrics, training details, and limitations of bardsai/eu-pii-anonimization"
order: 2
---

# Model Card

**bardsai/eu-pii-anonimization** is a token classification model fine-tuned for detecting personally identifiable information (PII) in Polish text, aligned with EU GDPR definitions.
...
| **Labels** | 37 entity types, BIO tagging (75 labels) |
| **Language** | Polish |
| **License** | Apache 2.0 |
| **Repository** | [bardsai/eu-pii-anonimization](https://huggingface.co/bardsai/eu-pii-anonimization) |
